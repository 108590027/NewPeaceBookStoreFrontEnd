...
const Demos: FC = () => {
  ...
  return (
    <div className='mb-0'>
      <h3 className='fw-bolder text-center mb-6'>{import.meta.env.VITE_THEME_NAME} Demos</h3>
          ...
          <div className='col-6'>
            <div
              className={`overlay overflow-hidden position-relative ${
                import.meta.env.VITE_THEME_DEMO === item.name
            ...
            >
              ...
              <div className='overlay-layer bg-dark bg-opacity-10'>
                {item.available && (
                  <a
                    href={`${import.meta.env.VITE_PREVIEW_REACT_URL}/${item.name}`}
