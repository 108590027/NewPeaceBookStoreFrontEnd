        ...
        <div className='card shadow-none w-100'>
          ...
          <div className='card-header' id='kt_explore_header'>
            <h5 className='card-title fw-bold text-gray-600'>
              Explore {import.meta.env.VITE_THEME_NAME}
            </h5>
            ...
            >
              <div className='mb-7'>
                <div className='d-flex flex-stack'>
                  <h3 className='mb-0'>{import.meta.env.VITE_THEME_NAME} Licenses</h3>
              ...
              <a href={import.meta.env.VITE_PURCHASE_URL} className='btn btn-primary mb-15 w-100'>
                Buy Now
              </a>
            </div>
            {/* end::Content */}
